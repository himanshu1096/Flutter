...
class DetailPage extends StatefulWidget {
  ...
  DetailPage({Key? key, required this.sign}) : super(key: key);
...
class _DetailPageState extends State<DetailPage> with TickerProviderStateMixin {
  ...
  Future<List<String>> getData() async {
    ...
    var url = Uri.parse(
        "https://rapidapi.com/Alejandro99aru/api/horoscope-astrology/${selectedSpan.toLowerCase()}/${widget.sign.name}");
